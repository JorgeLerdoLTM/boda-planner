    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1, marginBottom: 1 }}>
        ...
        <div style={{ ...glassCard, padding: 28 }}>
          ...
          <SliderInput label="Tasa de cancelacion" value={cancelRate} min={0} max={40} onChange={setCancelRate} format={(v) => `${v}%`} accent={C.ink} />
          ...
          <div style={{ borderTop: `1px solid ${C.stone}`, paddingTop: 16, marginTop: 8, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 600, color: C.ink }}>{attendees}</span>
          </div>
        </div>
        ...
        <div style={{ ...glassCard, padding: 28 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            <Pill label={`Fijo ${fmt(fixedTotal)}`} bg={C.blueXlt} color={C.blue} />
      ...
      {/* Category breakdown */}
      <div style={{ ...glassCard, padding: 28, marginBottom: 1 }}>
        ...
        <ResponsiveContainer width="100%" height={Math.max(200, catBreakdown.length * 28)}>
          <BarChart data={catBreakdown} layout="vertical" margin={{ left: 10, right: 40 }}>
        ...
        <div style={{ ...glassCard, padding: 28 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1, marginBottom: 16 }}>
            {[
              ...
              <div key={s.label} style={{ background: C.cream, padding: "16px", textAlign: "center" }}>
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 600, color: s.color }}>{s.val}</div>
          ...
          <div style={{ textAlign: "center" }}>
            <Pill label={`${plusOnes} con +1`} bg={C.yellowLt} color="#8B6914" />
          </div>
        </div>
